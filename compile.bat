...
g++ -shared -w src/controller_extern.cpp vertex.o hexagon.o gameboard.o gameboard_chunk.o controller.o util.o global_consts.o -IC:\python27\include -LC:\python27\libs -lpython27 -lopengl32 -lglu32 -lglew32 -lfreeglut -o controller.so
